...
public class Coords 
{
	...
	public static double getNextX(int x, double d, double s)
	{
		return x + (s * Math.cos(d * Math.PI / 180.0));
	}

	/** get next y coord from speed and direction */
	public static double getNextY(int y, double d, double s)
	{
		return y + (s * Math.sin(d * Math.PI / 180.0));
	}

	/** get next xy coords from speed and direction */
	public static double[] getNextXY(int x, int y, double d, double s)
	{
